...
///
/// Goals:
/// - Stable top-level keys for downstream tools
/// - Include as much context as possible (db_dir, subject, route, dosage, events, result)
/// - Be flexible across engines (pk/effect/hrt)
