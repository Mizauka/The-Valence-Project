...
export interface InitOutput {
    ...
    readonly __wbg_get_drugrecord_depot_model: (a: number) => number;
    readonly __wbg_get_drugrecord_display_unit: (a: number) => [number, number];
    readonly __wbg_get_drugrecord_dose_unit: (a: number) => [number, number];
    readonly __wbg_get_drugrecord_group_id: (a: number) => [number, number];
    readonly __wbg_get_drugrecord_model_type: (a: number) => [number, number];
    readonly __wbg_get_drugrecord_molecular_weight: (a: number) => number;
    readonly __wbg_get_drugrecord_name: (a: number) => [number, number];
    readonly __wbg_get_routeinfo_route: (a: number) => [number, number];
    readonly __wbg_get_routeinfo_unit: (a: number) => [number, number];
    ...
    readonly __wbg_routeinfo_free: (a: number, b: number) => void;
    ...
    readonly __wbg_set_drugrecord_depot_model: (a: number, b: number) => void;
    readonly __wbg_set_drugrecord_display_unit: (a: number, b: number, c: number) => void;
    readonly __wbg_set_drugrecord_dose_unit: (a: number, b: number, c: number) => void;
    readonly __wbg_set_drugrecord_group_id: (a: number, b: number, c: number) => void;
    readonly __wbg_set_drugrecord_model_type: (a: number, b: number, c: number) => void;
    readonly __wbg_set_drugrecord_molecular_weight: (a: number, b: number) => void;
    readonly __wbg_set_drugrecord_name: (a: number, b: number, c: number) => void;
    readonly __wbg_set_routeinfo_route: (a: number, b: number, c: number) => void;
    readonly __wbg_set_routeinfo_unit: (a: number, b: number, c: number) => void;
    ...
    readonly drugrecord_params: (a: number) => any;
